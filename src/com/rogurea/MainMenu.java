...
public class MainMenu {
    ...
    private static String[] loadNames() throws IOException {
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(MainMenu.class.getResource("/thank_names.csv").openStream()));
        return bufferedReader.lines().collect(Collectors.toList()).toArray(String[]::new);
    }
}
