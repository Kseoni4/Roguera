...
public class GameResources {
    ...
    public static final String version = "0.2.0:0506:0100dev";
    ...
    public static void LoadResources() {
        ...
        for(String file : resources){
            ...
            try {
                ...
                //InputStreamReader isr = new InputStreamReader(new FileInputStream(FilePath+file+FileExtension));
